...
function ResultPage() {
  ...
  return (
    ...
    {combinedImage ? (
      <div className="image-container">
        <img src={combinedImage} alt="Combined Result" className="combined-image" />
      </div>
    ) : (
      <p>No image found to display.</p>
    )}
  ...
  <div className="qr-code-container">
    ...
    <QRCodeCanvas value={imageUrl} size={250} level="H" className="qrcode" /> {/* Render QR Code with desired props */}
  </div>
